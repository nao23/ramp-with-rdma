...
public class CoreWorkload extends Workload
{
  ...
  public static final String TRANSACTION_LENGTH = "txnlen";
    
  public static final String TRANSACTION_LENGTH_DEFAULT = "8";
    ...
    for (int i = 0; i < fieldcount; i++) {
		...
		transactionLength= Integer.parseInt(p.getProperty(TRANSACTION_LENGTH, TRANSACTION_LENGTH_DEFAULT));
  ...
  private String buildDeterministicValue(String key, String fieldkey) {
	...
	public boolean doInsert(DB db, Object threadstate) {
	    ...
	    return (db.commit().equals(Status.OK));
	}
  ...
  protected void verifyRow(String key, HashMap<String,ByteIterator> cells) {
	...
	public void doTransactionRead(DB db) {
	    ...
	    long st=System.nanoTime();
            ...
            if (ret == Status.OK) {
                _measurements.measure("READ-TXN", (int)((accum)/1000));
            }
	}
	    ...
	    long st=System.nanoTime();
            ...
            if (ret == Status.OK) {
                _measurements.measure("READ-MODIFY-WRITE", (int)((accum)/1000));
            }
	}
	...
	public void doTransactionUpdate(DB db) {
		...
		long en=System.nanoTime();
            ...
            if (ret == Status.OK) {
                _measurements.measure("UPDATE-TXN", (int)((accum)/1000));
            }
	...
	public void doTransactionInsert(DB db) {
	    ...
	    long st=System.nanoTime();
            ...
            if (ret == Status.OK) {
                _measurements.measure("INSERT-TXN", (int)((accum)/1000));
            }
	}
}
